...
Aggregate  (cost=8737.20..8737.21 rows=1 width=128)
  ->  Nested Loop  (cost=1012.74..8737.19 rows=1 width=80)
        ->  Nested Loop  (cost=1012.31..8736.16 rows=1 width=69)
              Join Filter: (t.id = ci.movie_id)
              ->  Nested Loop  (cost=1011.74..8706.32 rows=1 width=85)
                    ->  Nested Loop  (cost=1011.61..8706.15 rows=1 width=89)
                          ->  Nested Loop  (cost=1011.47..8705.97 rows=1 width=93)
                                Join Filter: (t.id = mi.movie_id)
                                ->  Nested Loop  (cost=1011.03..8687.33 rows=1 width=42)
                                ...
                                ->  Index Scan using movie_id_movie_info on movie_info mi  (cost=0.43..18.63 rows=1 width=51)
                                      Index Cond: (movie_id = mk.movie_id)
