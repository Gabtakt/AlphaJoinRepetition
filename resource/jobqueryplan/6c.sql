...
Aggregate  (cost=3766.12..3766.13 rows=1 width=96)
  ->  Nested Loop  (cost=8.21..3766.11 rows=1 width=48)
        ->  Nested Loop  (cost=7.78..3765.65 rows=1 width=37)
              Join Filter: (t.id = ci.movie_id)
              ->  Nested Loop  (cost=7.21..3763.64 rows=1 width=41)
