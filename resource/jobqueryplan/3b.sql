...
Aggregate  (cost=16554.97..16554.98 rows=1 width=32)
  ->  Nested Loop  (cost=7.65..16554.97 rows=1 width=17)
        Join Filter: (t.id = mi.movie_id)
        ->  Nested Loop  (cost=7.21..16453.87 rows=68 width=25)
        ...
        ->  Index Scan using movie_id_movie_info on movie_info mi  (cost=0.43..1.47 rows=1 width=4)
