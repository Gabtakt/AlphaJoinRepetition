...
Aggregate  (cost=7447.28..7447.29 rows=1 width=96)
  ->  Nested Loop  (cost=8.92..7447.27 rows=1 width=41)
        Join Filter: (mi.info_type_id = it1.id)
        ->  Nested Loop  (cost=8.92..7444.85 rows=1 width=45)
              Join Filter: (t.id = mi.movie_id)
              ->  Nested Loop  (cost=8.49..7442.92 rows=1 width=57)
                    Join Filter: (mc.company_type_id = ct.id)
                    ->  Nested Loop  (cost=8.49..7441.83 rows=1 width=61)
                          ->  Nested Loop  (cost=8.07..7441.28 rows=1 width=46)
