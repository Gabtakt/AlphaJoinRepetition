...
Aggregate  (cost=3866.12..3866.13 rows=1 width=96)
  ->  Nested Loop  (cost=8.21..3866.11 rows=1 width=48)
        ->  Nested Loop  (cost=7.78..3773.71 rows=202 width=37)
              Join Filter: (t.id = ci.movie_id)
              ->  Nested Loop  (cost=7.21..3763.63 rows=5 width=41)
