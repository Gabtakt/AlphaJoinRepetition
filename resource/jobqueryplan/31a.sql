...
Aggregate  (cost=9002.63..9002.64 rows=1 width=128)
  ->  Nested Loop  (cost=1012.91..9002.62 rows=1 width=80)
        Join Filter: (mi.movie_id = t.id)
        ->  Nested Loop  (cost=1012.48..9001.51 rows=1 width=83)
              ->  Nested Loop  (cost=1012.05..9000.21 rows=1 width=72)
                    ->  Nested Loop  (cost=1011.90..9000.03 rows=1 width=76)
