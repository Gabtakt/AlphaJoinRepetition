...
Aggregate  (cost=5216.57..5216.58 rows=1 width=64)
  ->  Nested Loop  (cost=9.48..5201.50 rows=3013 width=33)
        Join Filter: (n.id = an.person_id)
        ->  Nested Loop  (cost=9.06..4571.45 rows=1295 width=25)
              ->  Nested Loop  (cost=8.63..3982.35 rows=1295 width=21)
                    Join Filter: (t.id = ci.movie_id)
                    ->  Nested Loop  (cost=8.06..3859.35 rows=61 width=29)
                          ->  Nested Loop  (cost=7.64..3784.05 rows=169 width=33)
