...
Aggregate  (cost=15248.43..15248.44 rows=1 width=96)
  ->  Nested Loop  (cost=8.21..15206.47 rows=5595 width=48)
        ->  Nested Loop  (cost=7.78..12661.31 rows=5595 width=37)
              Join Filter: (t.id = ci.movie_id)
              ->  Nested Loop  (cost=7.21..12366.92 rows=146 width=41)
