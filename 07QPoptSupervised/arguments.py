...
def get_args():
    ...
    parse.add_argument('--noise-scale', type=float, default=0.1, help='noise scale')
    ...
    parse.add_argument('--max-episode', type=int, default=1000000, help='the max length of episode to train the agent')
    ...
    parse.add_argument('--critic-lr', type=float, default=1e-2, help='the learning rate of critic network')
